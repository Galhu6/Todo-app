    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow flex flex-col items-center gap-20 p-8 bg-gray-100 dark:bg-gray-950">
        ...
        <section className="w-full max-3xl bg-gray-800/50 rounded shadow-lg p-6 space-y-4 animate-fade-in id=about">
          <h2 className="mb-2 text-xl font-semibold" id="about">
            About Us
          </h2>
          <p>
            Our mission is to help you stay organized and productive. Todo.io
            was built to make task management simple while offering powerful
        ...
        <section
          className="w-full max-w-3xl bg-gray-800/50 rounded shadow-lg p-6 space-y-2 animate-fade-in"
          id="programming"
        >
          <h2 className="mb-2 text-xl font-semibold">
            The back and front scenes:
          </h2>
          <p>
            React and Tailwind power the interface while an Express API with
        ...
        >
          ...
          <p>
            ...
            <a href="mailto:support@todo.io">support@todo.io</a>
          </p>
        </section>
      </main>
      <Footer />
