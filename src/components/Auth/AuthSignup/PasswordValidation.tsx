            ...
            <div>
                ...
                {password.length > 0 && (
                    <ul className="mt-2 space-y-1 text-sm">
                        <li style={{ color: getColor(criteria.length) }}>8 characters minimum</li>
                        <li style={{ color: getColor(criteria.uppercase) }}>At least one capital letter (A-Z)</li>
                        <li style={{ color: getColor(criteria.number) }}>At least one number (0-9)</li>
                        <li style={{ color: getColor(criteria.specialChar) }}>At least one special character</li>
                        <li style={{ color: getColor(criteria.englishOnly) }}>only english characters</li>
                    </ul>
                )}
            </div>
            <div>
