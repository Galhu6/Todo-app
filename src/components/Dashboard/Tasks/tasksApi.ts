...
export const allTasks = async (listId: number) => authFetch(`${server}/api/lists/${listId}/tasks/`, {
    method: "GET",
}).then(res => res.json()).then(data => data.task);

export const deletedTasks = async (listId: number) => authFetch(`${server}/api/lists/${listId}/tasks/trash`, {
    method: "GET",
}).then(res => res.json()).then(data => data.task);
...
export const setTaskPending = async (listId: number, taskId: number) => authFetch(`${server}/api/lists/${listId}/tasks/${taskId}/set-pending`, {
    method: "POST",
}).then(res => res.json()).then(data => data.task);
