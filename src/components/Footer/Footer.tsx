...
export const Footer = () => {
    return (
        <footer className="bg-gray-900/80 backdrop-blur-lg text-gray-300 mt-auto w-full">
            <div className="max-w-6xl mx-auto px-4 py-8 grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 items-start">
                <div>
                ...
                <div className="order-last sm:order-none flex flex-col items-center text-center gap-4">
                    <div>
                ...
                <div className="order-2 sm:order-none text-right sm:text-center md:text-center space-y-2 justify-self-end">
                    <h3 >
